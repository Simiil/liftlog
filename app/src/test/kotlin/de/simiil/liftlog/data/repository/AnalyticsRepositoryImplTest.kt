...
class AnalyticsRepositoryImplTest {
    ...
    private class FakeAnalyticsDao(
        ...
        override fun observeAllSetsSince(fromMillis: Long): Flow<List<SetRow>> =
        ...
        override fun observeSetsForExercise(exerciseId: String, fromMillis: Long): Flow<List<SetRow>> =
            flowOf(perExercise[exerciseId].orEmpty())
    }
