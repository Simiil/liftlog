...
class ExerciseDaoTest {
    ...
    @Test fun observeAll_includesHidden_excludesDeleted_orderedByName() =
        runTest {
    ...
    @Test fun countLive_excludesTombstones() =
        runTest {
            dao.insert(ex("1", "Bench"))
