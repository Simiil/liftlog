...
class BackupRoundTripTest {
    ...
    private suspend fun seed() {
        ...
        dao.insertWorkoutPlans(listOf(
            WorkoutPlanEntity("pl1", "PPL", 0, createdAt = 1, updatedAt = 1, deletedAt = null)))
        dao.insertPlanDayTemplates(listOf(
            PlanDayTemplateEntity("td1", "pl1", "Push", 0, createdAt = 1, updatedAt = 1, deletedAt = null)))
        dao.insertTemplateExercises(listOf(
            TemplateExerciseEntity("te1", "td1", "ex1", 0, targetSets = 3, targetRepsMin = 5,
                targetRepsMax = 8, createdAt = 1, updatedAt = 1, deletedAt = null)))
        dao.insertSessions(listOf(
            SessionEntity("s1", templateId = "td1", templateNameSnapshot = "Push", startedAt = 100,
                endedAt = 200, note = null, createdAt = 100, updatedAt = 200, deletedAt = null)))
    ...
    fun `export then wipe then import restores every row and the settings`() = runTest {
        ...
        dao.deleteAllTemplateExercises(); dao.deleteAllPlanDayTemplates(); dao.deleteAllWorkoutPlans()
