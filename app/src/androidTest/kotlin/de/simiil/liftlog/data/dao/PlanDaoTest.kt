...
class PlanDaoTest {
    ...
    @Test fun observePlans_excludesTombstones_orderedByPosition() =
        runTest {
    ...
    @Test fun dayTemplatesForPlan_excludesTombstones_orderedByPosition() =
        runTest {
    ...
    @Test fun templateExercisesFor_excludesTombstones_orderedByPosition() =
        runTest {
    ...
    @Test fun softDeleteDayTemplatesForPlan_tombstonesDeletedAtAndUpdatedAt() =
        runTest {
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
    ...
    @Test fun softDeleteDayTemplatesForPlan_doesNotTouchAlreadyTombstoned() =
        runTest {
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
    ...
    @Test fun softDeleteTemplateExercisesForPlan_tombstonesExercisesAcrossAllDayTemplates() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
            dao.insertPlan(plan("p2", "Plan 2", position = 2))
    ...
    @Test fun softDeletePlan_setsDeletedAtAndUpdatedAt() =
        runTest {
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
            dao.insertPlan(plan("p2", "Plan 2", position = 2))
    ...
    @Test fun observePlan_emitsLivePlan_thenNullAfterSoftDelete() =
        runTest {
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
    ...
    @Test fun observeDayTemplatesForPlan_orderedByPosition_excludesTombstones() =
        runTest {
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
    ...
    @Test fun observeTemplateExercisesFor_orderedByPosition_excludesTombstones() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
            dao.insertDayTemplate(dayTemplate("d1", "p1", "Day 1", position = 1))
    ...
    @Test fun maxPlanPosition_nullForEmptyTable_maxLivePositionOtherwise() =
        runTest {
    ...
    @Test fun maxDayTemplatePosition_nullForEmptyTemplate_maxLivePositionOtherwise() =
        runTest {
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
    ...
    @Test fun maxTemplateExercisePosition_nullForEmptyTemplate_maxLivePositionOtherwise() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
            dao.insertDayTemplate(dayTemplate("d1", "p1", "Day 1", position = 1))
            assertNull(
                "no exercises → maxTemplateExercisePosition should be null",
    ...
    @Test fun updateTemplateExercisePosition_writesPositionAndUpdatedAt_leavesOtherColumnsIntact() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
            dao.insertDayTemplate(dayTemplate("d1", "p1", "Day 1", position = 1))
    ...
    @Test fun softDeleteDayTemplate_tombstonesDayOnly_siblingsUntouched() =
        runTest {
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
            dao.insertDayTemplate(dayTemplate("d1", "p1", "Day 1", position = 1))
            dao.insertDayTemplate(dayTemplate("d2", "p1", "Day 2", position = 2))
    ...
    @Test fun softDeleteTemplateExercisesForTemplate_tombstonesDayExercises_leavesOtherDayUntouched() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
            dao.insertDayTemplate(dayTemplate("d1", "p1", "Day 1", position = 1))
    ...
    @Test fun softDeleteDayTemplate_andItsExercises_combinedCascade_siblingsUntouched() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
            dao.insertDayTemplate(dayTemplate("d1", "p1", "Day 1", position = 1))
    ...
    @Test fun softDeleteTemplateExercise_tombstonesExactlyOneRow() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
            dao.insertDayTemplate(dayTemplate("d1", "p1", "Day 1", position = 1))
    ...
    @Test fun observeMostRecentlyUsedPlanId_returnsLatestTemplatePlanId() =
        runTest {
    ...
    @Test fun observeMostRecentlyUsedPlanId_returnsEmptyWhenNoTemplateSession() =
        runTest {
            dao.insertPlan(plan("pA", "Plan A", position = 0))
    ...
    @Test fun observeMostRecentlyUsedPlanId_ignoresDeletedSessions() =
        runTest {
            dao.insertPlan(plan("pA", "Plan A", position = 0))
            dao.insertPlan(plan("pB", "Plan B", position = 1))
            dao.insertDayTemplate(dayTemplate("dA", "pA", "Day A", position = 0))
    ...
    @Test fun observeMostRecentlyUsedPlanId_skipsSoftDeletedPlan() =
        runTest {
            dao.insertPlan(plan("pA", "Plan A", position = 0))
            dao.insertPlan(plan("pB", "Plan B", position = 1))
            dao.insertDayTemplate(dayTemplate("dA", "pA", "Day A", position = 0))
    ...
    @Test fun observeFirstPlanId_returnsLowestPositionLivePlan() =
        runTest {
            dao.insertPlan(plan("p2", "Plan 2", position = 2))
            dao.insertPlan(plan("p0", "Plan 0", position = 0))
            dao.insertPlan(plan("p1", "Plan 1", position = 1))
    ...
    @Test fun observeFirstPlanId_returnsEmptyWhenNoPlans() =
        runTest {
            dao.observeFirstPlanId().test {
                val result = awaitItem()
                assertEquals(emptyList<String>(), result)
    ...
    @Test fun observeFirstPlanId_excludesTombstonedPlans() =
        runTest {
    ...
    @Test fun snapshotIsolation_mutatingTemplateDoesNotAffectSessionExercises() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            ...
            assertNull(
                "session_exercise must still be live",
