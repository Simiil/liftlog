...
class PickerQueriesDaoTest {
     ...
     */
    @Test fun recentlyUsed_orderedByMostRecentCompletedAtDesc() =
        runTest {
            ...
            val seBEx2 = sessionExercise("seB_ex2", "sB", "ex2")
            sessionDao.insertSessionExercise(seBEx2)
            ...
            val seAEx1 = sessionExercise("seA_ex1", "sA", "ex1")
            val seAEx2 = sessionExercise("seA_ex2", "sA", "ex2")
            sessionDao.insertSessionExercise(seAEx1)
            sessionDao.insertSessionExercise(seAEx2)
     ...
     */
    @Test fun recentlyUsed_exerciseWithOnlySoftDeletedSet_doesNotAppear() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            exerciseDao.insert(exercise("ex2"))
     ...
     */
    @Test fun recentlyUsed_setsUnderSoftDeletedSessionExercise_doNotCount() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            exerciseDao.insert(exercise("ex2"))
     ...
     */
    @Test fun recentlyUsed_setsUnderSoftDeletedSession_doNotCount() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            exerciseDao.insert(exercise("ex2"))
     ...
     */
    @Test fun setCountsBySession_countsAllLiveSetsAcrossExercises() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            exerciseDao.insert(exercise("ex2"))
     ...
     * This test would fail if the `ls.deletedAt IS NULL` join condition were removed.
     */
    @Test fun setCountsBySession_softDeletedSetsNotCounted() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
     ...
     */
    @Test fun setCountsBySession_sessionWithZeroLiveSets_isAbsent() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            exerciseDao.insert(exercise("ex2"))
     ...
     */
    @Test fun setCountsBySession_multipleSessionsReturnDistinctRows() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
     ...
     */
    @Test fun setCountsBySession_setsUnderSoftDeletedSessionExercise_doNotCount() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
            exerciseDao.insert(exercise("ex2"))
     ...
     * from the query.
     */
    @Test fun setCountsBySession_softDeletedSession_isAbsent() =
        runTest {
            exerciseDao.insert(exercise("ex1"))
